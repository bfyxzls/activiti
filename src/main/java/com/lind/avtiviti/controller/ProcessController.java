...
public class ProcessController {
     ...
     * @return
     * @throws IOException
     * @RequestMapping上加入produces告诉Spring，我们要返回的MediaType是一个图片（image/jpeg），然后加上@ResponseBody注解，方法返回byte[]，然后将图片读进byte[]
     */
    @RequestMapping(value = "/getActivitiImg/{id}", method = RequestMethod.GET, produces = MediaType.IMAGE_JPEG_VALUE)
    @ResponseBody
    public byte[] getActivitiImg(@PathVariable String id, HttpServletResponse response) throws IOException {
